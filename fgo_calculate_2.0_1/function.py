...
'''
1.将从者图片添加到主窗口
2.进行测试，确认无误后更新数据库，并尝试添加新的功能
注：5周年强化的数据暂未更新，ssy宝具本数据暂未更新
'''
...
class MyWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def set_servant_info(self):
        ...
        for row in f_csv_1:
            # print([row[3], row[4], row[5], row[7], row[19], row[20], row[21], row[22], row[23]])
            # print(row)
    ...
    def create_servant(self):
        ...
        self.atk, self.effect, self.class_addition = self.servant.get_calculate_result()
